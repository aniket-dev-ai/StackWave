        ...
        >
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 mb-6">
            {[
              ...
              <button key={index} className={`flex items-center gap-2 ${color} text-white px-4 py-4 rounded-full ${hover} transition`}>
                <Icon />  
              </button>
            ))}
          </div>

          <div className="text-center text-gray-500 dark:text-gray-300 my-3">OR</div>
            ...
            {[
              ...
              <input
                ...
                className={`w-full px-4 py-3 border rounded transition ${
                  theme === "light" ? "bg-light-100 text-green-800 border-gray-300 focus:border-green-500" : "bg-dark-300 border-gray-600 focus:border-green-400"
                }`}
              />
            ))}
 
            <textarea placeholder="Bio" className={`w-full px-4 py-3 border rounded transition ${
                  theme === "light" ? "bg-light-100 text-green-800 border-gray-300 focus:border-green-500" : "bg-dark-300 border-gray-600 focus:border-green-400"
                }`}></textarea>

            <select className={`w-full px-4 py-3 border rounded transition ${
                  theme === "light" ? "bg-light-100 text-green-800 border-gray-300 focus:border-green-500" : "bg-dark-300 border-gray-600 focus:border-green-400"
                }`}>
